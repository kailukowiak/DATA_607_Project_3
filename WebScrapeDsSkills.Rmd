...
Proof of Concept:
```{r}
url <- "https://www.indeed.com/jobs?q=Data+Scientist&l=Boston%2C+MA&start=20" #Test URL
...
# #creating DataFrame
 dfc <- data.frame(CompanyName,TitleName, City, ExperienceList)
# kable(df)
```
