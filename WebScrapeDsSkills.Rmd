...
write_csv(skillTable, "/Users/kailukowiak/Data607Proj3/rankedSkills.csv")
write_csv(skillTable, "/Users/kailukowiak/Data607Proj3/rawSkills.csv")
...
m2 <- mongo(url = "mongodb://127.0.0.1:27017" )
...
```{r}
separate(df, ExperienceList, into=paste("V",1:6, sep=""), sep=",") %>%
